...
def _result(candidate_id: str, document: str, score: float,
            metadata: dict[str, str] | None = None) -> HybridSearchResult:
    return HybridSearchResult(
        candidate=HybridCandidate(
            id=candidate_id, document=document, metadata=metadata or {},
        ),
        vector_score=score, lexical_score=score, final_score=score,
    )
